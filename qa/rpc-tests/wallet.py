...
#   c) node1 mines 32 blocks, so now node 0 has 60001obsr, node 1 has 4250obsr, node2 has none.
#   d) node0 sends 601 obsr to node2, in two transactions (301 obsr, then 300 obsr).
