Contributing to OBSR Core
============================

The OBSR Core project operates an open contributor model where anyone is
...
The following applies to code changes to the OBSR Core project, and is not to be
confused with overall OBSR Network Protocol consensus changes.

Whether a pull request is merged into OBSR Core rests with the project merge
...
Patches that change OBSR consensus rules are considerably more involved than
...
Where a patch set proposes to change the OBSR consensus, it must have been
...
The project leader is the release manager for each OBSR Core release.
