...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Obsr Core obsr-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  obsr-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded obsr transaction") + "\n" +
                               "  obsr-tx [options] -create [commands]   " + _("Create hex-encoded obsr transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded obsr transaction
