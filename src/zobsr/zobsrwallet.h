...
#ifndef OBSR_ZOBSRWALLET_H
#define OBSR_ZOBSRWALLET_H
...
public:
    CzOBSRWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZOBSR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZOBSR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
