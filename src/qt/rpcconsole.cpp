                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzOBSRPathCustom = GetArg("-zobsrbackuppath", "");
    ...
    if(!strzOBSRPathCustom.empty()) {
        ui->wallet_customzobsrbackuppath->setText(QString::fromStdString(strzOBSRPathCustom));
        ui->wallet_customzobsrbackuppath_label->setVisible(true);
        ui->wallet_customzobsrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzOBSRPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the OBSR RPC console.") + "<br>" +
