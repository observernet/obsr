...
In order to support loading of multiple wallets in obsr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is obsr.cpp.
...
Changes to obsr.cpp
----------------------
obsr.cpp is the entry point into obsr-qt, and as such, will require some minor modifications to provide hooks for
