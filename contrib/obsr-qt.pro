...
RESOURCES += src/qt/obsr.qrc src/qt/obsr_locale.qrc

TRANSLATIONS += src/qt/locale/obsr_bg.ts \
                src/qt/locale/obsr_de.ts \
                src/qt/locale/obsr_en.ts \
                src/qt/locale/obsr_es.ts \
                src/qt/locale/obsr_fi.ts \
                src/qt/locale/obsr_fr.ts \
                src/qt/locale/obsr_it.ts \
                src/qt/locale/obsr_ja.ts \
                src/qt/locale/obsr_pl.ts \
                src/qt/locale/obsr_pt.ts \
                src/qt/locale/obsr_ru.ts \
                src/qt/locale/obsr_sk.ts \
                src/qt/locale/obsr_sv.ts \
                src/qt/locale/obsr_vi.ts \
                src/qt/locale/obsr_zh_CN.ts \
                src/qt/locale/obsr_zh_TW.ts
